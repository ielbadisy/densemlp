...
`mlp` fits multilayer perceptrons for tabular classification and regression in
R using `torch`. It is designed for data-frame workflows: pass a formula or
`x`/`y` inputs, let the package preprocess numeric and categorical predictors,
then use standard prediction, metrics, tuning, and interpretation helpers.
